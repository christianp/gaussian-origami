	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$core$String$fromInt(-$author$project$Main$draw_bound)),
				$elm$svg$Svg$Attributes$x2(
				$elm$core$String$fromInt($author$project$Main$draw_bound)),
				$elm$svg$Svg$Attributes$y1(
				$elm$core$String$fromInt((2 * x) - $author$project$Main$draw_bound)),
				$elm$svg$Svg$Attributes$y2(
				$elm$core$String$fromInt((2 * x) + $author$project$Main$draw_bound)),
				$elm$svg$Svg$Attributes$stroke('hsla(0,0%,0%,0.2)'),
				$elm$svg$Svg$Attributes$strokeWidth($author$project$Main$line_width)
			]),
		_List_Nil);
};
...
var $author$project$Main$view_line = function (line) {
	switch (line.$) {
		case 'Horizontal':
			var y = line.a;
			var d = line.b;
...
var $author$project$Main$view_closest_line = function (model) {
	...
	var x = _v0.a;
	var y = _v0.b;
	var line = A2($author$project$Main$closest_line, x, y);
	return $author$project$Main$view_line(line);
};
...
var $author$project$Main$viewSVG = function (model) {
	...
	var fixedpoints = $elm$core$Set$toList(
		A2($elm$core$Set$intersect, pointset, nextpoints));
	var disappearingpoints = $elm$core$Set$toList(
		A2($elm$core$Set$diff, pointset, nextpoints));
	...
	return A2(
		...
		_Utils_ap(
			A2(
				$elm$core$List$map,
				$author$project$Main$view_vertical_line,
				A2($elm$core$List$range, -$author$project$Main$draw_bound, $author$project$Main$draw_bound)),
			_Utils_ap(
				A2(
					$elm$core$List$map,
					$author$project$Main$view_horizontal_line,
					A2($elm$core$List$range, -$author$project$Main$draw_bound, $author$project$Main$draw_bound)),
				_Utils_ap(
					A2(
						$elm$core$List$map,
						$author$project$Main$view_updiagonal_line,
						A2($elm$core$List$range, -$author$project$Main$draw_bound, $author$project$Main$draw_bound)),
					_Utils_ap(
						A2(
							$elm$core$List$map,
							$author$project$Main$view_downdiagonal_line,
							A2($elm$core$List$range, -$author$project$Main$draw_bound, $author$project$Main$draw_bound)),
						_Utils_ap(
							_List_fromArray(
								[
