...
var $author$project$Main$reflect = F2(
	function (line, _v0) {
		...
		switch (line.$) {
			case 'Horizontal':
				var y = line.a;
				return _Utils_Tuple2(px, (2 * y) - py);
			case 'Vertical':
				var x = line.a;
				return _Utils_Tuple2((2 * x) - px, py);
			case 'DownDiagonal':
				var z = line.a;
				return _Utils_Tuple2(py - (2 * z), px + (2 * z));
			default:
				var z = line.a;
				return _Utils_Tuple2((-py) + (2 * z), (2 * z) - px);
		}
	});
var $author$project$Main$fold = F2(
	function (_v0, p) {
		var dir = _v0.a;
		var line = _v0.b;
		var rp = A2($author$project$Main$reflect, line, p);
		var _v1 = p;
		var px = _v1.a;
		var py = _v1.b;
		switch (line.$) {
			...
			case 'DownDiagonal':
				var z = line.a;
				if (dir.$ === 'Forwards') {
					return (_Utils_cmp(px, py - (2 * z)) > 0) ? rp : p;
				} else {
					return (_Utils_cmp(px, py - (2 * z)) < 0) ? rp : p;
				}
			default:
				var z = line.a;
				if (dir.$ === 'Forwards') {
					return (_Utils_cmp(px, (2 * z) - py) > 0) ? rp : p;
				} else {
					return (_Utils_cmp(px, (2 * z) - py) < 0) ? rp : p;
				}
		}
	...
	function (_v0, p) {
		...
		return _List_fromArray(
			[
				p,
				A2(
				$author$project$Main$fold,
				_Utils_Tuple2(dir, line),
				p)
			]);
	});
...
var $author$project$Main$DownDiagonal = function (a) {
	return {$: 'DownDiagonal', a: a};
};
...
var $author$project$Main$UpDiagonal = function (a) {
	return {$: 'UpDiagonal', a: a};
};
		...
		return _Utils_Tuple2(
			{
				...
				previous: previous,
				scale: 5,
				selectedLine: $elm$core$Maybe$Nothing,
				url: url
			},
...
var $author$project$Main$closest_horizontal_line = F2(
	function (x, y) {
		...
		return _Utils_Tuple2(
			_Utils_Tuple2(
				dir,
				$author$project$Main$Horizontal(iy)),
			d);
	});
	...
	function (x, y) {
		...
		if (l.b.$ === 'Horizontal') {
			...
			return _Utils_Tuple2(
				_Utils_Tuple2(
					dir,
					$author$project$Main$DownDiagonal(z)),
				d);
		} else {
			return _Utils_Tuple2(
				_Utils_Tuple2(
					$author$project$Main$Forwards,
					$author$project$Main$UpDiagonal(0)),
				2);
		}
	});
var $author$project$Main$closest_vertical_line = F2(
	function (x, y) {
		...
		return _Utils_Tuple2(
			_Utils_Tuple2(
				dir,
				$author$project$Main$Vertical(ix)),
			d);
	});
	...
	function (x, y) {
		...
		if (l.b.$ === 'Vertical') {
			...
			return _Utils_Tuple2(
				_Utils_Tuple2(
					dir,
					$author$project$Main$UpDiagonal(z)),
				d);
		} else {
			return _Utils_Tuple2(
				_Utils_Tuple2(
...
var $author$project$Main$closest_line = function (_v0) {
	var x = _v0.a;
	var y = _v0.b;
	...
	return A2(
		...
		_Utils_Tuple2(
			_Utils_Tuple2(
				$author$project$Main$Forwards,
				$author$project$Main$Horizontal(0)),
			2.0),
		lines).a;
};
var $author$project$Main$side_of = F2(
	function (line, _v0) {
		var x = _v0.a;
		var y = _v0.b;
		var left = function () {
			switch (line.$) {
				case 'Horizontal':
					var z = line.a;
					return _Utils_cmp(y, z) > 0;
				case 'Vertical':
					var z = line.a;
					return _Utils_cmp(x, z) > 0;
				case 'UpDiagonal':
					var z = line.a;
					return _Utils_cmp(x, (-y) + (2 * z)) > 0;
				default:
					var z = line.a;
					return _Utils_cmp(x, y - (2 * z)) > 0;
			}
		}();
		return left ? $author$project$Main$Backwards : $author$project$Main$Forwards;
	});
var $author$project$Main$do_move = F2(
	function (model, line) {
		var dir = A2($author$project$Main$side_of, line, model.mouse);
		var cmd = _Utils_Tuple3(model.command, dir, line);
		var npoints = A2($author$project$Main$do_command, cmd, model.points);
		return _Utils_eq(npoints, model.points) ? _Utils_update(
			model,
			{selectedLine: $elm$core$Maybe$Nothing}) : _Utils_update(
			model,
			{
				next: _List_Nil,
				points: npoints,
...
var $author$project$Main$make_command = function (model) {
	return A2(
		...
		function (l) {
			return _Utils_Tuple3(
				model.command,
				A2($author$project$Main$side_of, l, model.mouse),
				l);
		},
		model.selectedLine);
};
...
var $author$project$Main$do_click = function (model) {
	...
	var _v0 = $author$project$Main$closest_line(model.mouse);
	var dir = _v0.a;
	var line = _v0.b;
	var _v1 = model.selectedLine;
	if (_v1.$ === 'Nothing') {
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					selectedLine: $elm$core$Maybe$Just(line)
				}),
			$elm$core$Platform$Cmd$none);
	} else {
		var l = _v1.a;
		return _Utils_eq(line, l) ? _Utils_Tuple2(
			_Utils_update(
				model,
				{selectedLine: $elm$core$Maybe$Nothing}),
			$elm$core$Platform$Cmd$none) : $author$project$Main$setUrl(
			A2($author$project$Main$do_move, model, l));
	}
};
		...
		switch (msg.$) {
			case 'Toggle':
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 'Click':
				return $author$project$Main$do_click(model);
			case 'MouseMoveAt':
				var x = msg.a;
				var y = msg.b;
				return _Utils_Tuple2(
...
var $author$project$Main$draw_bound = 100;
...
var $author$project$Main$Deselecting = {$: 'Deselecting'};
var $author$project$Main$Selecting = {$: 'Selecting'};
var $elm$core$String$fromFloat = _String_fromNumber;
var $elm$svg$Svg$line = $elm$svg$Svg$trustedNode('line');
var $author$project$Main$line_width = 0.05;
var $elm$svg$Svg$Attributes$stroke = _VirtualDom_attribute('stroke');
var $elm$svg$Svg$Attributes$strokeWidth = _VirtualDom_attribute('stroke-width');
var $author$project$Main$view_downdiagonal_line = function (x) {
	return _Utils_Tuple2(
		_Utils_Tuple2(-$author$project$Main$draw_bound, (2 * x) - $author$project$Main$draw_bound),
		_Utils_Tuple2($author$project$Main$draw_bound, (2 * x) + $author$project$Main$draw_bound));
};
var $author$project$Main$view_horizontal_line = function (x) {
	return _Utils_Tuple2(
		_Utils_Tuple2(-$author$project$Main$draw_bound, x),
		_Utils_Tuple2($author$project$Main$draw_bound, x));
};
var $author$project$Main$view_updiagonal_line = function (x) {
	return _Utils_Tuple2(
		_Utils_Tuple2(-$author$project$Main$draw_bound, (2 * x) + $author$project$Main$draw_bound),
		_Utils_Tuple2($author$project$Main$draw_bound, (2 * x) - $author$project$Main$draw_bound));
};
var $author$project$Main$view_vertical_line = function (x) {
	return _Utils_Tuple2(
		_Utils_Tuple2(x, -$author$project$Main$draw_bound),
		_Utils_Tuple2(x, $author$project$Main$draw_bound));
};
...
var $author$project$Main$view_line = F2(
	function (style, line) {
		var style_attrs = function () {
			switch (style.$) {
				case 'Normal':
					return _List_fromArray(
						[
							$elm$svg$Svg$Attributes$stroke('hsla(0,0%,0%,0.2)'),
							$elm$svg$Svg$Attributes$strokeWidth(
							$elm$core$String$fromFloat($author$project$Main$line_width))
						]);
				case 'Deselecting':
					return _List_fromArray(
						[
							...
							$elm$svg$Svg$Attributes$strokeWidth(
							$elm$core$String$fromFloat(2 * $author$project$Main$line_width))
						]);
				default:
					return _List_fromArray(
						[
							$elm$svg$Svg$Attributes$stroke('hsl(240,50%,50%)'),
							$elm$svg$Svg$Attributes$strokeWidth(
							$elm$core$String$fromFloat(1.5 * $author$project$Main$line_width))
						]);
			}
		}();
		var _v0 = function () {
			switch (line.$) {
				case 'Horizontal':
					var y = line.a;
					return $author$project$Main$view_horizontal_line(y);
				case 'Vertical':
					var x = line.a;
					return $author$project$Main$view_vertical_line(x);
				case 'UpDiagonal':
					var n = line.a;
					return $author$project$Main$view_updiagonal_line(n);
				default:
					var n = line.a;
					return $author$project$Main$view_downdiagonal_line(n);
			}
		}();
		var _v1 = _v0.a;
		var x1i = _v1.a;
			...
			_Utils_ap(
				...
				_List_fromArray(
					[
						...
						$elm$core$String$fromInt(x1i)),
						$elm$svg$Svg$Attributes$x2(
						$elm$core$String$fromInt(x2i)),
						$elm$svg$Svg$Attributes$y1(
						$elm$core$String$fromInt(y1i)),
						$elm$svg$Svg$Attributes$y2(
						$elm$core$String$fromInt(y2i))
					])),
			_List_Nil);
	});
var $author$project$Main$view_closest_line = function (model) {
	var deselecting = _Utils_eq(
		model.selectedLine,
		$elm$core$Maybe$Just(
			$author$project$Main$closest_line(model.mouse).b));
	var style = deselecting ? $author$project$Main$Deselecting : $author$project$Main$Selecting;
	var _v0 = $author$project$Main$closest_line(model.mouse);
	var dir = _v0.a;
	var line = _v0.b;
	var closest = A2($author$project$Main$view_line, style, line);
	var _v1 = model.selectedLine;
	if (_v1.$ === 'Nothing') {
		return closest;
	} else {
		var sl = _v1.a;
		return _Utils_eq(sl, line) ? closest : A2($author$project$Main$view_line, $author$project$Main$Selected, sl);
	}
};
			...
			A2(
				...
				_List_fromArray(
					[
						...
						$elm$svg$Svg$Attributes$fill(fillStyle)
					]),
				_List_Nil));
	});
var $author$project$Main$view_points = F2(
		...
		return A3(
			...
			A2(
				...
				function (_v0) {
					var s = _v0.a;
					var p = _v0.b;
					return A3($author$project$Main$view_point, model, s, p);
				},
				points));
	});
var $elm$svg$Svg$Attributes$width = _VirtualDom_attribute('width');
var $author$project$Main$viewSVG = function (model) {
	var view_selected_line = function () {
		var _v3 = model.selectedLine;
		if (_v3.$ === 'Nothing') {
			return _List_Nil;
		} else {
			var l = _v3.a;
			return _List_fromArray(
				[
					A2($author$project$Main$view_line, $author$project$Main$Selected, l)
				]);
		}
	}();
	...
	var nextpoints = A2(
		...
		A2(
			$elm$core$Maybe$map,
			function (cmd) {
				return A2($author$project$Main$do_command, cmd, model.points);
			},
			$author$project$Main$make_command(model)));
	var newpoints = function () {
		if (nextpoints.$ === 'Nothing') {
			return _List_Nil;
		} else {
			var ps = nextpoints.a;
			return $elm$core$Set$toList(
				A2($elm$core$Set$diff, ps, pointset));
		}
	}();
	var fixedpoints = function () {
		if (nextpoints.$ === 'Nothing') {
			return model.points;
		} else {
			var ps = nextpoints.a;
			return $elm$core$Set$toList(
				A2($elm$core$Set$intersect, pointset, ps));
		}
	}();
	var disappearingpoints = function () {
		if (nextpoints.$ === 'Nothing') {
			return _List_Nil;
		} else {
			var ps = nextpoints.a;
			return $elm$core$Set$toList(
				A2($elm$core$Set$diff, pointset, ps));
		}
	}();
	var all_points = _Utils_ap(
		A2(
			$elm$core$List$map,
			function (p) {
				return _Utils_Tuple2($author$project$Main$FixedPoint, p);
			},
			fixedpoints),
		_Utils_ap(
			A2(
				$elm$core$List$map,
				function (p) {
					return _Utils_Tuple2($author$project$Main$Disappearing, p);
				},
				disappearingpoints),
			A2(
				$elm$core$List$map,
				function (p) {
					return _Utils_Tuple2($author$project$Main$Appearing, p);
				},
				newpoints)));
	return A2(
		$elm$svg$Svg$svg,
		_List_fromArray(
			[
				...
				A3(
					...
					$author$project$Main$MouseMoveAt,
					A2(
			...
			A2(
				...
				A2(
					...
					function (z) {
						return _List_fromArray(
							[
								$author$project$Main$Horizontal(z),
								$author$project$Main$Vertical(z),
								$author$project$Main$UpDiagonal(z),
								$author$project$Main$DownDiagonal(z)
							]);
					},
					$elm$core$List$map(
						$author$project$Main$view_line($author$project$Main$Normal))),
				A2($elm$core$List$range, -$author$project$Main$draw_bound, $author$project$Main$draw_bound)),
			_Utils_ap(
				_List_fromArray(
					[
						$author$project$Main$view_closest_line(model)
					]),
				_List_fromArray(
					[
						A2($author$project$Main$view_points, model, all_points)
					]))));
};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id('command'),
								$elm$html$Html$Events$onClick($author$project$Main$Toggle)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(
								$author$project$Main$describeCommand(model.command))
							])),
						A2(
						$elm$html$Html$button,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id('zoom-in'),
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id('zoom-out'),
